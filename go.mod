...
require (
	...
	icode.baidu.com/baidu/gdp/bns v1.26.0 // indirect
	icode.baidu.com/baidu/gdp/conf v1.23.0 // indirect
	icode.baidu.com/baidu/gdp/env v1.22.1 // indirect
	icode.baidu.com/baidu/gdp/exjson v1.1.3 // indirect
	icode.baidu.com/baidu/gdp/extension v1.26.0 // indirect
	icode.baidu.com/baidu/gdp/logit v1.27.0 // indirect
...
require (
	...
	icode.baidu.com/baidu/gdp/ghttp v1.30.0
	icode.baidu.com/baidu/gdp/net v1.34.1
)
